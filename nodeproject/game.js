...
function loadImage() { // 각 요소별 이미지 가져오기
    ...
    backgroundImage.src = "/static/image/bg3.jpg"

    spaceshipImage = new Image();
    spaceshipImage.src = "/static/비행기.png"

    bulletImage = new Image();
    bulletImage.src = "/static/총알.png"

    enemyImage = new Image();
    enemyImage.src = "/static/외계인.png"

    gameOverImage = new Image();
    gameOverImage.src = "/static/게임오버.png"
}
